...
def create_deepfashion2_label_colormap(rgb=False, maximum=255):
  """
  Args:
...
def create_label_colormap(dataset=_PASCAL):
  ...
  elif dataset == _DEEPFASHION2:
    return create_deepfashion2_label_colormap()
  else:
